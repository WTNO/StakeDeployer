...
func configGethConfig() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/geth.service", size: 393, mode: os.FileMode(420), modTime: time.Unix(1692268171, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"config/geth.service": configGethConfig,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"config": &bintree{nil, map[string]*bintree{
		...
		"geth.service": &bintree{configGethConfig, map[string]*bintree{}},
	}},
}}
